...
In this project the goal was to predict, which passanger survived the Titanic shipwreck.
...
We filter Parch.9 column out.

```{r }

train_x <- select(train_x, -Parch.9)
test_x <- select(test_x, -Parch.9)
